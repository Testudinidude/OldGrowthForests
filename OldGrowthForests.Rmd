...
Covars_oldgrowth$cwd_score<-cwd_combined
...
Now, let's subset to our highest values (9 and 10).

```{r}
oldgrowthscore_coords_comm_forestsub_highestscore<-oldgrowthscore_coords_comm_forestsub[oldgrowthscore_coords_comm_forestsub$oldgrowthscore > 8,]
...
Some of our most "old growth"-like locations are in Bradley Woods, Rocky River, North Chagrin, and South Chagrin. 
